...
/**
 * Controller for the host lobby screen — room creation, player list management,
 * and game start for LAN multiplayer.
 */
public class AddPlayerScreenController implements StageAware, Initializable {
    ...
    private Consumer<NetworkMessage> lobbyListener;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        updateModeUi();
        lobbyListener = msg -> Platform.runLater(() -> syncLobbyFromServer(msg));
        HostLobbyBridge.setListener(lobbyListener);
    }
    ...
    void onBack(ActionEvent event) {
        if (lobbyListener != null) {
            HostLobbyBridge.removeListener(lobbyListener);
        }
