...
/**
 * Base class for action states on the game state stack — controls who can act
 * and how targets respond, overriding normal turn flow when active.
 */
public abstract class ActionState implements Serializable {
    ...
    /** Execute the post-acceptance side effect for a target. Override in subclasses with onAccepted callbacks. */
