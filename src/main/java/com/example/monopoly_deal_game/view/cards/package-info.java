/**
 * <h2>卡牌 GUI（与 {@link com.example.monopoly_deal_game.model.Card} 家族平行）</h2>
 * <p>
 ...
 * <h3>继承关系（实现顺序可参考）</h3>
 * <pre>
 * {@link com.example.monopoly_deal_game.model.Card} (model)
 ...
 *
 * <p>
 * 工厂：{@link com.example.monopoly_deal_game.view.cards.CardNodeFactory#from(com.example.monopoly_deal_game.model.Card)}，
 * Controller 或 {@link com.example.monopoly_deal_game.view.GameplayViewCoordinator} 只依赖 {@link com.example.monopoly_deal_game.model.Card}，
 * 不直接 new 具体 Node 子类。
 * </p>
 */
