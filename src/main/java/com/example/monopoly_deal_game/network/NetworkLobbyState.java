...
/**
 * Holds the local client's lobby state — room identity, player name,
 * readiness flag, and the latest session snapshot from the host.
 */
public final class NetworkLobbyState {
    ...
    public void removeListener(Consumer<NetworkMessage> listener) {
